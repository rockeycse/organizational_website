                ...
                <div class="post">
                    ...
                    <div class="post-content">
                        ...
                        <div class="entry-summary">
                            <p>Meh synth Schlitz, tempor duis single-origin coffee ea next level ethnic fingerstache fanny pack nostrud. Photo booth anim 8-bit hella, PBR 3 wolf moon beard <strong>Helvetica</strong>. Salvia esse nihil, flexitarian Truffaut synth art party deep v chillwave. Seitan High Life reprehenderit consectetur cupidatat kogi. Et leggings fanny pack, elit bespoke vinyl art party Pitchfork selfies master cleanse</p>
                        ...
                        <ul class="media-list">
                            <li class="media">
                                <div class="post-comment">
                                    <a class="pull-left" href="#">
                                        <img class="media-object" src="images/team/4.jpg" alt="">
                                    </a>
                                    <div class="media-body">
                                        <h3>John Doe says:</h3>
                                        <h4>23/02/2015</h4>
                                ...
                                <ul class="parent media-list">
                                    ...
                                    <li class="post-comment">
                                        <a class="pull-left" href="#">
                                            <img class="media-object" src="images/team/5.jpg" alt="">
                                        </a>
                                        <div class="media-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <form id="comment-form" class="row" name="comment-form" method="post">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <textarea name="message" id="message" required="required" class="form-control" rows="7" placeholder="Your Comment"></textarea>
                                        </div>
                                    </div>
