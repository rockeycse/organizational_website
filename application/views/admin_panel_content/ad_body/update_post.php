    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <?php echo form_open_multipart('MasterAdminController/update_post_data'); ?>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body box-profile col-sm-8 col-lg-offset-2">
                                ...
                                <div class="col-md-8">
                                    <div class="input-group">
                                        ...
                                        <input class=" fa-th form-control" name="admin_post_title" id="admin_post_title"
                                               value="<?php echo $post_data[0]['admin_post_title']; ?>"
                                ...
                                <div class="col-md-8">
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" rows="6" name="admin_post_description"
                                                  id="admin_post_description" placeholder="Enter ..."
                                                  required><?php echo $post_data[0]['admin_post_description']; ?></textarea>
                                ...
                                <div class="col-md-8">
                                    <div class="input-group">
                                        ...
                                        <input class=" fa-th form-control" name="admin_post_date"
                                               ...
                                               value="<?php echo $post_data[0]['admin_post_date']; ?>"
                                               required>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-8">
                                    <div class="input-group">
                                        ...
                                        <input class=" fa-th form-control" name="admin_post_author"
                                               id="admin_post_author" placeholder="Author" type="text"
                        ...
                        <input class="fa-th form-control" type="hidden" name="admin_post_id" id="admin_post_id"
                               value="<?php echo $post_data[0]['admin_post_id']; ?>">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
