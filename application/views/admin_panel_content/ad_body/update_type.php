<div class="content-wrapper">
    <div class="container">
        ...
        <?php echo form_open_multipart('MasterAdminController/update_post_type_data'); ?>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="post_type_name" name="post_type_name"
                                       placeholder="Post Category Name" value="<?php echo $post_type_data[0]['post_type_name']?>" required>
                            </div>
                            <input type="hidden" class="form-control" id="post_type_id" name="post_type_id"
                                   value="<?php echo $post_type_data[0]['post_type_id']?>" required>
