...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo base_url();?>ad_res/plugins/iCheck/square/blue.css">
...
<!--        <a href="--><?php //echo base_url();?><!--ad_res/index2.html"><b>Admin</b>Login</a>-->
<!--    </div>-->
    <!-- /.login-logo -->
...
//        } ?>
        ...
        <form action="<?php echo base_url();?>LoginController/check_login_data" method="post">
